...
Language strings are kept in /lang, with one json file per language and key-value pairs. The key names are directly referenced in html attributes to populate text fields.
The language files can be merged into [`lang.json`](/lang.json) with the builder python script at [merge_lang.py](/merge_lang.py)
